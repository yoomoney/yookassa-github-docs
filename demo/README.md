...
3. Наша система проверяет полученные на eshop.xml параметры и если они верные, плательщик видит нашу страницу оплаты, выбирает способ оплаты, вводит номер карты и т.д., нажимает "оплатить".  
