...
##### Все ссылки
* [Пример платежной форма](https://github.com/yandex-money/yandex-money-joinup/blob/master/demo/пример%20платежной%20формы.html) _(пример минимального кода, достачный для проведения оплаты)_;
