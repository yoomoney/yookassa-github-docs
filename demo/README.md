...
Рекомендуемые нами сценарий оплаты ([презентация](https://kassa.yandex.ru/pay_by_yandex); файл дизайна кнопки: [pay_by_yandex_btn.zip](https://kassa.yandex.ru/files/pay_by_yandex_btn.zip)).
