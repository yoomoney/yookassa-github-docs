...
* [рекомендации по скриптам взаимодействия (checkURL и avisoURL)](#Шаг-2-Скрипты-checkurl-и-avisourl-колбеки)
  * [формат ответов](#Примеры-ответов-колбеков-checkurl-и-avisourl)
  * [как защитить сумму платежа от подмены](#22-Проверка-md5-суммы-при-ответах-на-запросы-checkorder-и-paymentaviso-документация)
