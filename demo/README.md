...
На этой странице вы найдете пошаговое описание тестирования: пример кода минимальной платежной формы, описание процесса платежа, рекомендации по скриптам проверки заказа и успеха оплаты, решение ошибок при тестировании, презентацию процесса оплаты методом "оплатить через яндекс", ссылки на файлы дизайна, раздел FAQ и Рекомендации.
...
* [Минимальная платежная форма](https://github.com/yandex-money/yandex-money-joinup/blob/master/demo/минимальная%20платежная%20формы.html)
