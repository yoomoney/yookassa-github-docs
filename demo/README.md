...
На этой странице вы найдете необходимые ссылки, примеры и пошаговое описание тестирования: html-код минимальной платежной формы, описание процесса платежа, рекомендации по скриптам проверки заказа и успеха оплаты, рекомендации по защите платежа, решение ошибок при тестировании; рекомендации по кнопке оплаты "Заплати через Яндекс".
