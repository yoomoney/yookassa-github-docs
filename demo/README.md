...
##### Все ссылки
* [Пример платежной формы](https://github.com/yandex-money/yandex-money-joinup/blob/master/demo/пример%20платежной%20формы.html) _(минимальный код, достачный для проведения оплаты)_;
