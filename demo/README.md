...
* [рекомендации по скриптам взаимодействия](#Шаг-2-Скрипты-checkurl-и-avisourl-колбеки)
  ...
  * [коды ответов скриптов checkURL и avisoURL на платежные запросы Яндекс.Кассы](#Все-коды-ответов)
