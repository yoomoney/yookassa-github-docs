...
_(информации достаточно для того, чтобы вы смогли реализовать оплату на вашем сайте [всеми доступными платежными методами](https://kassa.yandex.ru/payments))_
