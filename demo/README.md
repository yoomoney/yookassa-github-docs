...
_Представленной информации достаточно для того, чтобы вы смогли реализовать оплату на вашем сайте с помощью платежной системы Яндекс.Касса [всеми доступными платежными методами](https://kassa.yandex.ru/payments)._
