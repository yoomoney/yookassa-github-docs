...
1. Создайте форму оплаты, прописав в ней **shopId** и **scid**.
2. Разместите код на свою страницу или закачате страницу с формой на свой сайт.
3. Создайте скрипты для обработки наших запросов (скрипт checkURL и скрипт avisoURL; это может быть один скрипт, который будет обработывать оба запроса).
4. Выполните тестирование.
5. После успешной оплаты в демо-режиме, напишите в ответ на наше письмо и мы переведем вас в боевой режим. Если при оплате в демо-режиме возникнут ошибки и информации на данной странице будет не достаточно, напишите в ответ на наше письмо и наши техники помогут вам (подробнее о том, какая информация нам нужна для диагностики, см. в инструкции ниже).
