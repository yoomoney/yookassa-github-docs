...
Представленной информации достаточно для того, чтобы вы смогли реализовать оплату на вашем сайте с помощью платежной системы Яндекс.Касса. Ваши плательщики смогут производить оплату [всеми доступными платежными методами](https://kassa.yandex.ru/payments).

### Требования к интеграции
* Вы должны [зарегистрироваться в Яндекс.Кассе](https://money.yandex.ru/joinups/) (доступно для юридических лиц и ИП) и заполнить нашу [техническую анкету](https://tech.yandex.ru/money/doc/payment-solution/shop-config/parameters-docpage/);
