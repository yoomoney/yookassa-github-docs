...
1. Создайте форму оплаты, прописав в ней ваши **shopId** и **scid**.
...
4. После успешной оплаты в демо-режиме, напишите в ответ на наше письмо и мы переведем вас в боевой режим.
5. Если при тестировании возникнут ошибки и информации на данной странице будет не достаточно, напишите нам (подробнее о том, какая информация нам нужна для диагностики, см. в инструкции ниже).
