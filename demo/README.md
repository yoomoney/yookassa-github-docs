> [шаги интеграции](#Шаги-интеграции) | [общий план](#Общий-план) | [описание процесса платежа](#Описание-процесса-платежа) | [платежная форма](#Платежная-форма) | [check|aviso-обзор](#Шаг-2-Скрипты-checkurl-и-avisourl-колбеки) | [md5](#Шаг-21-Проверка-md5-суммы-при-ответах-на-запросы-checkorder-и-paymentaviso-документация) | [примеры ответов check|aviso](#Шаг-22-Примеры-ответов-колбеков-checkurl-и-avisourl) | [коды ответов](#Коды-ответов)
