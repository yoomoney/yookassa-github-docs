...
* [Зарегистрируйтесь в Яндекс.Кассе](https://money.yandex.ru/joinups/) (доступно только для юридических лиц, ИП ~~и покемонов~~);
...
| `code="100"`| такого заказа нет в магазине (например, срок действия заказа истёк | в авизо такого ответа нет| 
