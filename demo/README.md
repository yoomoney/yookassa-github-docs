...
На этой странице вы найдете необходимые ссылки на документацию, примеры и пошаговое описание тестирования: пример html-кода минимальной платежной формы, описание процесса платежа, рекомендации по скриптам проверки заказа и успеха оплаты, решение ошибок при тестировании; рекомендации по кнопке оплаты "Заплати через Яндекс".
