...
- если инициировать оплату демо-кошельком не создав его и не залогинившись в него, то на странице оплаты не будет доступна оплата кошельком (см. инструкцию ниже, как сделать тестовый кошелек)
```
