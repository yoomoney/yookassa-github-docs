...
> **Обязательно покажите эту информацию вашему техническому специалисту или программисту**, чтобы было выполнено необходимое обновление на вашей сторонее.

* [О смене бренда](https://new.yookassa.ru/)
* Официальная новость "[Платежный сервис ЮMoney завершает переименование](https://yoomoney.ru/page?id=536896)"
...
По вашему shopid=100500 мы видим, что для платежей (отправки запросов по платежному протоколу ЮKassa) вы используете 
старый хост payment.yandex.net (адрес принадлежит компании Яндекс). 
Вам нужно начать использовать новый хост api.yookassa.ru (принадлежит компании Юмани|ЮKassa), 
иначе до конца апреля 2022 платежи могут перестать работать.
