...
По вашему shopid=182893 https://cc.yooteam.ru/ticket?requestId=25425159мы видим, что для платежей (отправка запросов по платежному протоколу ЮKassa от вашего ПО) вы используете старый хост payment.yandex.net (адрес принадлежит компании Яндекс).
...
(по этим ссылкам мы собрали все необходимые ответы по данному кейсу; страницы обновляются по мере поступления новой информации) 
