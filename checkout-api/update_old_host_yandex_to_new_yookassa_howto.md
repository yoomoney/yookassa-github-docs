...
Если Вы не используете готовое SDK (см. ниже), а код вашего сайта в части работы с ЮKassa написан вашим разработчиком самостоятельно. В коде вашего ПО замените:
