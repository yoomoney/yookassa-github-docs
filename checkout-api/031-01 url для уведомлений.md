...
В таком виде вы получите наше уведомление:
```
...
### PHP, рекомендации для получения уведомлений

**q**: Мы сделали все так, как написано выше, чтобы получить уведомление, но в PHP скрипт не получает никакие данные.
