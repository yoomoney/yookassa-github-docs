...
==================================================
> :mortar_board: На этой странице представлено тестовые окружение для работы с нашим API. Кликаете по нужному запросу, получаете результат, читайте аннотацию на вкладке "Docs". Вы будете взаимодействовать с нашей боевой системой в режиме real-time (проведение платежа, отмена или проведение возврат). Любой шаг можно провести самостоятельно, получив наглядное предоставление, что отправляется, какой ответ можно получить и т.д.
