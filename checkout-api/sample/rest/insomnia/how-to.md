...
> :mortar_board: Необходимо освоить наше API максимально быстро? Это может занять 5 минут. С помощью подтоговленного нами тестового окружения, работающего на основе программы [Insomnia](https://insomnia.rest/) (популярный, бесплатный REST-клиент, работающий на операционных системах Windows, OSX и Ubuntu) вы на практике поймете все необходимые запросы.

### Overview

Так будет выглядеть ваше тестовое окружение после установки Insomnia и импорта нашей коллекции. Кликаете по нужному запросу, получаете результат, читайте краткую аннотацию по запросу на вкладке "Docs". Взаимодействие идет с нашей боевой системой происходит в режиме real-time.
