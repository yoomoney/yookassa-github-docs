...
==================================================
> На этой странице представлено удобное тестовые окружение, чтобы освоить наше API:
...
Так будет выглядеть тестовое окружение после установки Insomnia и импорта нашей коллекции. Кликаете по нужному запросу, получаете результат, читайте аннотацию на вкладке "Docs". Взаимодействие с нашей боевой системой будет происходить в режиме real-time.
