...
> * Вы будете взаимодействовать с нашей боевой системой в режиме real-time (выполняя запрос, вы получите наглядное представление, что отправляется, какой ответ возвращается и т.д.). Сможете при необходимости изменить запрос.
