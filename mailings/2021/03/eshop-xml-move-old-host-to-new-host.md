...
Ю Если все-таки платежи перестанут работать, посмотрите на решение "[Выставление счетов из ЛК ЮKassa](https://yookassa.ru/docs/support/merchant/payments/invoicing)". Оно будет работать всегда вне зависимости ПО вашего сайта. Это может быть для вас временным решением по приему платежей.
