...
1. После того, как вы в коде вашего ПО замените хост в `action` на новый, платежи продолжат работать как и прежде. Смена хоста - это единственное изменение, которое требуется, чтобы вы внесли в код своей системы, чтобы в определенный момент платежи не сломались.
