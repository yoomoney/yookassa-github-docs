...
**A:** Это электронная цифровая подпись, которым подписываются наши письма с реестрами. В принципе, вы можете его открыть, если у вас на компьютере есть программа для просмотра файла подписи. Например, в Outlook вы увидите значок, нажав на который можно просмотреть содержимое цифровой подписи
![цифровая подпись в outlook инонка](/demo/digital_signature_outlook-ico.png "цифровая подпись в outlook иконка")
