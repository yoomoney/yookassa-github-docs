...
**A:** Это электронная цифровая подпись, которым подписываются наши письма с реестрами. В принципе, вы можете его открыть, если у вас на компьютере есть программа для просмотра файла подписи. Например, в Outlook вы увидите значок ![цифровая подпись в outlook инонка](/demo/digital_signature_outlook-ico.png "цифровая подпись в outlook иконка"), нажав дважды на который можно просмотреть содержимое цифровой подписи

![цифровая подпись в outlook](/demo/digital_signature_outlook.png "цифровая подпись в outlook")

Обычно вы видите такой файл как вложение, если почтовая программа или вебинтерфейс не поддерживают их просмотр.
